export const productsListObject = [
  {
    id: 0,
  ...
  {
    id: 1,
    name: "Camiseta Maneskin 'Zitti e Buoni'",
    price: 37.0,
    image:
  ...
  {
    id: 3,
    name: 'Camiseta Centralizar em CSS',
    price: 35.0,
    image:
  ...
  {
    id: 5,
    name: 'Camiseta Café Não Costuma Faiá',
    price: 40.0,
    image:
  ...
  {
    id: 6,
    name: 'Camiseta Khachapuri e Khinkali',
    price: 31.0,
    image:
  ...
  {
    id: 7,
    name: 'Camista Spread Ajvar Not Hate',
    price: 34.0,
    image:
